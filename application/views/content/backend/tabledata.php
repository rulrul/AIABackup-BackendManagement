<!-- Content-Header -->
				<div class="row">
					<div class="col-lg-12">
						<h2>Clients Data Header <small>Acommerce Integration Apps</small></h2>
						<ol class="breadcrumb">
							<li class="active"><i class="fa fa-dashboard"></i> cdmanagement</li>
						</ol>
							...
							<table class="table table-bordered table-hover tablesorter">
								...
								<tbody>
									...
									foreach($query as $row) {
										...
										echo "<td><a href='". base_url(). "cdmanagement/editheader/?id=". $row->id. "'>Edit</a> | <a class='openDialog' href='#' data-href='". base_url(). "delheader/?id=". $row->id. "'>Delete</a></td>";
										echo "</tr>";
									}
									?>
								</tbody>
